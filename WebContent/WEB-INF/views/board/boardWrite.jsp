                ...
                <div class="">
                    ...
                    <div class="row">
						...
						<form:form commandName="board" id="form" name="form" enctype="multipart/form-data">
							<div class="x_title">					
								<input type="text" id="b_title" name="b_title" class="form-control" style="width:75%;" placeholder="제목을 입력해주세요." maxlength="30">
						...
						<!-- <textarea class="editor-wrapper" name="b_content" id="b_content" style=" width:100%; outline:none;"></textarea> -->
							<div id="editor-one" class="editor-wrapper"></div>
								...
								<div class="form-group">
									<input type="button" onclick="submit_form( this.form.inputFile )" class="btn btn-primary" style="float:right;" value="등록">
		...
		function submit_form(file){
			...
			if(form.b_title.value == ""){
			 ...
			 for(var i=0; i<fileNames.length; i++){
				...
				image.src='/cktree/upload/'+uuidFileName;
