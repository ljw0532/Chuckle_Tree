...
.list {
  ...
  <body class="nav-md">
          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="title_right">
                  <form name="searchForm" method="get" action="${pageContext.request.contextPath}/board/funBoardList">
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <li><input type="button" onclick="goWrite()" value="글쓰기" class="btn btn-primary"></li>
                    </c:when>
                    <c:otherwise>
	...
	function goWrite(){
		location.href="/cktree/board/boardWrite";
	}
	
	function list(page) {
		location.href="${pageContext.request.contextPath}/board/funBoardList?curPage="+page
